<?php
	...
	$phoneext = $_POST["extension"];
	
	$officeinsert = mysqli_prepare($conn, "INSERT INTO 7062protutordetails (User_ID, RoomNumber, RoomAddress, PhoneExtension) VALUES (?,?,?,?)");
	mysqli_stmt_bind_param($officeinsert, 'isss', $id, $roomnumber, $roomaddress, $phoneext);
	
	mysqli_stmt_execute($officeinsert);
	
	mysqli_stmt_close($officeinsert);
