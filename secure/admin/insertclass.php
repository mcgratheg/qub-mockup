<?php
	...
	$classinsert = mysqli_prepare($conn, "INSERT INTO 7062proclassdetails (User_ID, Subject_ID) VALUES (?,?)");
	mysqli_stmt_bind_param($classinsert, 'ii', $id, $subjectid);
	
	mysqli_stmt_execute($classinsert);
	
	mysqli_stmt_close($classinsert);
