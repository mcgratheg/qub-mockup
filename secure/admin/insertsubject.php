<?php
	...
	$subjectinsert = mysqli_prepare($conn, "INSERT INTO 7062prosubject (SubjectLevel_ID, SubjectCode, SubjectName, SubjectDescription) VALUES (?,?,?,?)");
	mysqli_stmt_bind_param($subjectinsert, 'isss', $subjectlevel, $subjectcode, $subjectname, $subjectdesc);
	
	mysqli_stmt_execute($subjectinsert);
	
	mysqli_stmt_close($subjectinsert);
