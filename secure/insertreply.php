<?php
	...
	$replyinsert = mysqli_prepare($conn, "INSERT INTO 7062proreply (ReplyBy_ID, ReplyTopic_ID, ReplyContent) VALUES (?,?,?)");
	mysqli_stmt_bind_param($replyinsert, 'iis', $replyuser, $replytopic, $replycontent);
	
	mysqli_stmt_execute($replyinsert);
	
	mysqli_stmt_close($replyinsert);
