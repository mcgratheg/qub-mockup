		...
		<input type="checkbox" id="drawer-control" class="drawer">
			<nav class="drawer col-md-4 col-lg-2">
				...
				<ul>
					...
					<?php echo"<li><a href='displayprofile.php?userid=" . $user->get_id() . "' class='button'>" . $user->first_name() . " " . $user->get_last_name() . "</a></li>
					...
					while($row = $class_details_result->fetch_array(MYSQLI_ASSOC)){
						...
						echo "<div class='col-sm-12 col-md-7'>
									<div class='card fluid' id='subject'>
										<div class='section'>
											<div class='row'>
												<a href='displaysubject.php?subject=" . $subject->get_code() . "'><h3>$code : " . $subject->get_name() . "</h3></a>
											</div>	
											<br>
											<div class='row'>
											<p><a href='forum.php?subject=" . $subject->get_code() . "'>Discussion</a></p>
											<span>|</span>
